...
class PersonAdapter : RecyclerView.Adapter<PersonAdapter.ViewHolder>() {
    ...
    class ViewHolder(view : View) : RecyclerView.ViewHolder(view){
        ...
        val persoNumber : TextView

        init {
            personName = view.findViewById(R.id.personNameTV)
            persoNumber = view.findViewById(R.id.personNumberTV)
        }
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

       /* print("Hej Banan") this is Kolint print */
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       ...
       /* holder.personName.text = "Bartil " + position.toString() */
        ...
        holder.persoNumber.text = position.toString()
